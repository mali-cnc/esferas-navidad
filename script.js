...
const car_toogle2 = document.getElementById("mi_carrito2")
...
car_toogle.onclick = function () {//agrega tache de cierre de carrito de compras
...
car_toogle2.onclick = function () {//agrega tache de cierre de carrito de compras
  conteiner_carrito.classList.toggle("active")
  conteiner_general.classList.toggle("active")
  contacto_footer.classList.toggle("active")
...
const cart_quantity2 = document.getElementById("cart_quantity2")
...
function create_item(imagen_esfera, cantidad, precio, ad_nombre) {
...
esfera[1] = ["Esfera de gatito", "12x12", 20, true]
...
btn1.onclick = function () {
  ...
  cart_quantity2.innerText = acumulado_carro
  for (let i = 1; i <= carro; i++) {
    carrito.push(esfera[1])
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(1, 1,esfera[1][2],esfera[1][3])
...
esfera[2] = ["Esfera de hueso", "12x12", 20, true]
...
btn2.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(2, 1,esfera[2][2],esfera[2][3])
...
esfera[3] = ["Esfera de huella", "12x12", 20, true]
...
btn3.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(3, 1,esfera[3][2],esfera[3][3])
    costo_total=costo_total+esfera[3][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[4] = ["Esfera de arbol", "12x12", 15, true]
...
btn4.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(4, 1,esfera[4][2],esfera[4][3])
    costo_total=costo_total+esfera[4][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[5] = ["Esfera de estrella", "12x12", 15, true]
...
btn5.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(5, 1,esfera[5][2],esfera[5][3])
    costo_total=costo_total+esfera[5][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[6] = ["Esfera de luna", "12x12", 15, true]
...
btn6.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(6, 1,esfera[6][2],esfera[6][3])
    costo_total=costo_total+esfera[6][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[7] = ["Esfera de reno", "12x12", 20, true]
...
btn7.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(7, 1,esfera[7][2],esfera[7][3])
    costo_total=costo_total+esfera[7][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[8] = ["Esfera rota c/estrellas", "12x12", 20, true]
...
btn8.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(8, 1,esfera[8][2],esfera[8][3])
    costo_total=costo_total+esfera[8][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[9] = ["Esfera de reno 2", "12x12", 25, true]
...
btn9.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(9, 1,esfera[9][2],esfera[9][3])
    costo_total=costo_total+esfera[9][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[10] = ["Esfera de Santa", "12x12", 20, true]
...
btn10.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(10, 1,esfera[10][2],esfera[10][3])
    costo_total=costo_total+esfera[10][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[11] = ["Esfera de copo 1", "12x12", 20, true]
...
btn11.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(11, 1,esfera[11][2],esfera[11][3])
    costo_total=costo_total+esfera[11][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[12] = ["Esfera de angel 1", "12x12", 25, true]
...
btn12.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(12, 1,esfera[12][2],esfera[12][3])
    costo_total=costo_total+esfera[12][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[13] = ["Esfera de angel 2", "12x12", 20, true]
...
btn13.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(13, 1,esfera[13][2],esfera[13][3])
    costo_total=costo_total+esfera[13][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[14] = ["Esfera de mickey", "12x12", 20, true]
...
btn14.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(14, 1,esfera[14][2],esfera[14][3])
    costo_total=costo_total+esfera[14][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[15] = ["Esfera de batman", "12x12", 20, true]
...
btn15.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(15, 1,esfera[15][2],esfera[15][3])
    costo_total=costo_total+esfera[15][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[16] = ["Esfera de flash", "12x12", 20, true]
...
btn16.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(16, 1,esfera[16][2],esfera[16][3])
    costo_total=costo_total+esfera[16][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[17] = ["Esfera de superman", "12x12", 20, true]
...
btn17.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(17, 1,esfera[17][2],esfera[17][3])
    costo_total=costo_total+esfera[17][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[18] = ["Esfera de Harry Potter 1", "12x12", 20, true]
...
btn18.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(18, 1,esfera[18][2],esfera[18][3])
    costo_total=costo_total+esfera[18][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[19] = ["Esfera de Harry Potter 2", "12x12", 20, true]
...
btn19.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(19, 1,esfera[19][2],esfera[19][3])
    costo_total=costo_total+esfera[19][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[20] = ["Esfera de Harry Potter 3", "12x12", 20, true]
...
btn20.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(20, 1,esfera[20][2],esfera[20][3])
    costo_total=costo_total+esfera[20][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[21] = ["Esfera de sombrero HP", "12x12", 20, true]
...
btn21.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(21, 1, esfera[21][2],esfera[21][3])
    costo_total=costo_total+esfera[21][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[22] = ["Esfera navidad estrella", "12x12", 25, true]
...
btn22.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(22, 1, esfera[22][2],esfera[22][3])
    costo_total=costo_total+esfera[22][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[23] = ["Esfera regalo", "12x12", 25, true]
...
btn23.onclick = function () {
  ...
  for (let i = 1; i <= carro; i++) {
    ...
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(23, 1, esfera[23][2],esfera[23][3])
    costo_total=costo_total+esfera[23][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[24] = ["Esfera moño navideño", "12x12", 25, true]
const quantity24 = document.getElementById("q24")
const btn24 = document.getElementById("b24")

btn24.onclick = function () {
  carro = parseInt(quantity24.value)
  acumulado_carro = acumulado_carro + carro
  cart_quantity.innerText = acumulado_carro
  cart_quantity2.innerText = acumulado_carro

  for (let i = 1; i <= carro; i++) {
    carrito.push(esfera[24])
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(24, 1, esfera[24][2],esfera[24][3])
    costo_total=costo_total+esfera[24][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}

esfera[25] = ["Kit 12 esferas Avengers", "12x12", 200, false]
const quantity25 = document.getElementById("q25")
const btn25 = document.getElementById("b25")

btn25.onclick = function () {
  carro = parseInt(quantity25.value)
  acumulado_carro = acumulado_carro + carro
  cart_quantity.innerText = acumulado_carro
  cart_quantity2.innerText = acumulado_carro

  for (let i = 1; i <= carro; i++) {
    carrito.push(esfera[25])
    //create_item(numero de imagen, cantidad de esferas(siempre sera 1), precio)
    create_item(25, 1, esfera[25][2],esfera[25][3])
    costo_total=costo_total+esfera[25][2]
  }
  total_pesos.innerHTML= "TOTAL: $"+ parseInt(costo_total)
}
